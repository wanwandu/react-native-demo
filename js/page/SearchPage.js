...
import {FlatList, StyleSheet, Text, View, Platform, RefreshControl, ActivityIndicator, DeviceInfo, TextInput,TouchableOpacity} from 'react-native';
...
class SearchPage extends Component<Props> {
  ...
  saveKey() {
    ...
    if (Utils.checkKeyIsExist(keys, key)) {
      ...
      keys.unshift(key);// 将key添加到数据组的开头
